...
/**
 * Inline brand-mark SVGs. lucide-react v1 dropped social-brand icons for
 * trademark reasons, so we ship lightweight paths to keep the social row
 * recognisable without an extra icon dependency.
 */
const SocialIcon = ({ paths }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
...
const FOOTER_COLUMNS = [
  ...
  {
    title: "Job Seekers",
    links: ["Browse Jobs", "Browse Companies", "Salary Guide", "Resume Builder"],
  },
  {
    title: "Employers",
    links: ["Post a Job", "Search Resumes", "Pricing", "Recruiter Login"],
  },
  {
    title: "Support",
...
const Footer = () => {
  return (
    <footer className="border-t border-gray-100 bg-slate-900 text-gray-300">
      <Container className="py-12 sm:py-16">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-gray-400">
              ...
              with the right opportunities since day one.
            </p>
        ...
        {/* Bottom bar */}
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-6 text-sm text-gray-400 sm:flex-row">
          <p>© 2026 Naukri Clone. Built for a frontend assignment.</p>
